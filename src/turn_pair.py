...
from src.classroom_branch import JudgeResponse
...
class TurnPair:
    ...
    pedagogical_stage_alignment_advantage: Optional[float] = None  # Conversation's pedagogical stage alignment advantage
