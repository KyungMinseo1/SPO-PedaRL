...
class ClassroomBranchTrainer(Trainer):
    ...
    def _generate_and_score_completions(
        ...
        if self.accelerator.is_local_main_process:
            ...
            all_completion_ids, all_turn_pair_advs, all_node_rewards, all_problem_idx = (
        ...
        all_node_rewards = gather_object(all_node_rewards)
        ...
        node_rewards = [all_node_rewards[i] for i in my_idx]
        ...
        buckets: Dict[str, list] = {
            k: [] for k in [
                "accuracy_rewards", "eoc_rewards", "think_rewards",
                "pedagogical_rewards", "length_rewards",
                "accuracy_advs", "eoc_advs", "think_advs",
                "pedagogical_advs", "length_advs",
        ...
        all_rewards = {"accuracy", "end_of_conversation", "pedagogical_alignment", "length", "think"}
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if per_token_kl is not None:
            ...
            self._metrics[mode]["kl"].append(
                self.accelerator.gather_for_metrics(kl_mean).mean().item()
            )
