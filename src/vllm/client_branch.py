...
def sample_conversations_branch(
...
) -> Tuple[List[List[int]], List[List[Dict]], List[Dict], List[int], List[Dict]]:
    """
        ...
        conv_rewards_list.append(
            {
                ...
                "pedagogical_stage_alignment_reward": conv_data.get("pedagogical_stage_alignment_reward"),
                "think_reward": conv_data.get("think_reward"),
            }
        )
        problem_idx_list.append(conv_data["problem_idx"])
        accuracy_log_list.append(
            {
                "prior_accuracy": conv_data.get("prior_accuracy"),
                "post_accuracy": conv_data.get("post_accuracy"),
                "delta_accuracy": conv_data.get("delta_accuracy")
            }
        )
    ...
    return token_ids_list, turn_pair_adv_list, conv_rewards_list, problem_idx_list, accuracy_log_list
