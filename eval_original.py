...
def main(cfg: EvalConfig):
    ...
    leaked_mean = check_judge_decision('does_not_leak_answer', problem_num, number_of_times_to_average, conversations)
    does_not_follow_mean = check_judge_decision('follows_pedagogical_values', problem_num, number_of_times_to_average, conversations)
